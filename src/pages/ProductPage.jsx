...
export default function ProductPage({ product, setPage, setSelectedProduct }) {
  const { add } = useCart();
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-10 mb-16">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div>
            <div className="mb-5">
              <p className="text-4xl font-black text-blue-900">{formatPrice(product.price)}</p>
              <p className="text-sm text-gray-400">{formatInstallment(product.price, 3)}</p>
            </div>
            <button
              onClick={handleAdd}
